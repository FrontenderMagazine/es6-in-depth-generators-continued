...
совсем другим. Он мог бы выглядеть примерно так:
    ...
    доска с зажимом, весь из себя важный.

                              ЦИКЛ FOR
                             (вызывает)
                            someWords()!

    Входит ГЕНЕРАТОР: высокий, самоуверенный, пунктуальный джентльмен.
    ...
    Рывком вбегает ALERT, с широко распахнутыми глазами, запыхавшийся.
    Складывается ощущение, что он такой всегда.
    ...
    Пауза несколько секунд, затем ALERT мчится обратно, подбегает к
    ЦИКЛУ FOR и тормозит юзом.
    ...
    бездыханное тело ГЕНЕРАТОРА и уносит за кулисы.
